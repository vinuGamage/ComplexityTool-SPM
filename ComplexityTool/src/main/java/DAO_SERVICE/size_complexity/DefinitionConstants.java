...
public class DefinitionConstants {
    ...
    public final static String KEYWORDOPSSTRING[] = new String[]{" void ", " double ", " int ", " float ", " string ", "void ", "double ", "int ", "float ", "string ","args", " printf ", "main", " println ", " cout ", " cin ", "if ", "for ", "while", "do", "switch ", "case "};
    ...
    public final static String NAMESSTRING[] = new String[]{"class", "boolean", "long", "double", "number"};
