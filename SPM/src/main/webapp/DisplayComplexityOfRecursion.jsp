...
<title>Complexity of Recursion </title>
	...
	<style>
		...
		<div class="container" style="overflow: auto;min-height: 500px"> 
			...
			<div align="center">
				...
				<h1 class="display-1"
					...
					<font color="#00376c">Complexity of Recursion</font>
				</h1>
				<br> 
		...
		ArrayList<StatementLine> StatementListCr = (ArrayList<StatementLine>)session.getAttribute("Cr");
		
		
	     while(x<= codeLines.length){
	    	 StatementLine cr = StatementListCr.get(x-1) ;
